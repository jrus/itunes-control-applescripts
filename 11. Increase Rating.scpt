...
on increaseRating()
  tell application "iTunes"
    set the_rating to ((rating of current track) + 10)
    if the_rating > 100 then set the_rating to 100
    set rating of current track to the_rating
  end tell
end increaseRating
